...
process
{
    ...
    #region Push Location to BeforeBuild
    ...
    try
    {
        ...
        #region Setup Build Module Output
        <#
        ...
        #region Import Tasks from Modules
        ...
        #region Load Tasks from .build Folder
        ...
        #region Add Workflow from Configuration
...
begin
{
    #Region Find build config if not specified.
    if (-not $BuildConfig)
    {
    ...
    #region hand back to Invoke-Build
    if ($MyInvocation.ScriptName -notlike '*Invoke-Build.ps1')
    {
